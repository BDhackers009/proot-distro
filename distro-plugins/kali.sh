...
distro_setup() {
	...
	run_proot_cmd echo "if [ $(cat /data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/kali/etc/sudoers | grep $USER) = '' ]; then echo '$USER	ALL=(ALL:ALL) ALL' >>  /data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/kali/etc/sudoers;fi" >> /data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/kali/home/$USER/.bashrc
